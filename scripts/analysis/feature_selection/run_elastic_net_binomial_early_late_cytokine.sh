...
/allen/aics/gene-editing/RNA_seq/scRNAseq_SeeligCollaboration/2019_analysis/feature_selection/scripts/boelastic_net_binomial_early_late_cytokine.R \
    ...
    --analysis_name "early_late_cytokine"
